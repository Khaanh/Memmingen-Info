  ...
  return (
    <div className="container flex min-h-screen flex-col items-center justify-between">
      ...
      <div className='flex items-center flex-col'>
        ...
        <h2 className='text-2xl sm:text-3xl lg:w-3/4 text-gray-950 text-center font-medium'>Проект создан для помощи беженцам в поисках специалистов/врачей, которые говорят на русском/украинском языке в таких городах: <br /> Мемминген, Кемптен, Аугсбург, Мюнхен</h2>
      </div>
